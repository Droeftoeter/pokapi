...
/**
 * Protobuf message : POGOProtos.Map.Fort.FortSummary
 */
class FortSummary extends \Protobuf\AbstractMessage
{
    ...
    /**
     * fort_summary_id optional string = 1
     *
     * @var string
     */
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->fort_summary_id !== null) {
            ...
            $writer->writeString($stream, $this->fort_summary_id);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->fort_summary_id = $reader->readString($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->fort_summary_id !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->fort_summary_id);
        }
    ...
    {
        if ( ! $message instanceof \POGOProtos\Map\Fort\FortSummary) {
