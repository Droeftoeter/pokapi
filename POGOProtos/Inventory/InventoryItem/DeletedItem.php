...
/**
 * Protobuf message : POGOProtos.Inventory.InventoryItem.DeletedItem
 */
class DeletedItem extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Inventory\InventoryItem\DeletedItem) {
