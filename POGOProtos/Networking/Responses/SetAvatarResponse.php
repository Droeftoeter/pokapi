...
/**
 * Protobuf message : POGOProtos.Networking.Responses.SetAvatarResponse
 */
class SetAvatarResponse extends \Protobuf\AbstractMessage
{
     ...
     * Set 'status' value
     *
     * @param \POGOProtos\Networking\Responses\SetAvatarResponse\Status $value
     */
    public function setStatus(\POGOProtos\Networking\Responses\SetAvatarResponse\Status $value = null)
    {
        $this->status = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.POGOProtos.Networking.Responses.SetAvatarResponse.Status'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'player_data',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->status = \POGOProtos\Networking\Responses\SetAvatarResponse\Status::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Responses\SetAvatarResponse) {
