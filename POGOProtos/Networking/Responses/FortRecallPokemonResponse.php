...
/**
 * Protobuf message : POGOProtos.Networking.Responses.FortRecallPokemonResponse
 */
class FortRecallPokemonResponse extends \Protobuf\AbstractMessage
{
     ...
     * Set 'result' value
     *
     * @param \POGOProtos\Networking\Responses\FortRecallPokemonResponse\Result $value
     */
    public function setResult(\POGOProtos\Networking\Responses\FortRecallPokemonResponse\Result $value = null)
    {
        $this->result = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.POGOProtos.Networking.Responses.FortRecallPokemonResponse.Result'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'fort_details',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->result = \POGOProtos\Networking\Responses\FortRecallPokemonResponse\Result::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Responses\FortRecallPokemonResponse) {
