...
/**
 * Protobuf message : POGOProtos.Networking.Responses.GetPlayerResponse
 */
class GetPlayerResponse extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Responses\GetPlayerResponse) {
