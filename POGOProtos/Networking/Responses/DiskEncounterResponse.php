...
/**
 * Protobuf message : POGOProtos.Networking.Responses.DiskEncounterResponse
 */
class DiskEncounterResponse extends \Protobuf\AbstractMessage
{
     ...
     * Set 'result' value
     *
     * @param \POGOProtos\Networking\Responses\DiskEncounterResponse\Result $value
     */
    public function setResult(\POGOProtos\Networking\Responses\DiskEncounterResponse\Result $value = null)
    {
        $this->result = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.POGOProtos.Networking.Responses.DiskEncounterResponse.Result'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'pokemon_data',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->result = \POGOProtos\Networking\Responses\DiskEncounterResponse\Result::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Responses\DiskEncounterResponse) {
