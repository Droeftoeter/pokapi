...
/**
 * Protobuf message : POGOProtos.Networking.Responses.SetPlayerTeamResponse
 */
class SetPlayerTeamResponse extends \Protobuf\AbstractMessage
{
     ...
     * Set 'status' value
     *
     * @param \POGOProtos\Networking\Responses\SetPlayerTeamResponse\Status $value
     */
    public function setStatus(\POGOProtos\Networking\Responses\SetPlayerTeamResponse\Status $value = null)
    {
        $this->status = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.POGOProtos.Networking.Responses.SetPlayerTeamResponse.Status'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'player_data',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->status = \POGOProtos\Networking\Responses\SetPlayerTeamResponse\Status::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Responses\SetPlayerTeamResponse) {
