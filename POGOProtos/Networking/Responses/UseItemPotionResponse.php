...
/**
 * Protobuf message : POGOProtos.Networking.Responses.UseItemPotionResponse
 */
class UseItemPotionResponse extends \Protobuf\AbstractMessage
{
     ...
     * Set 'result' value
     *
     * @param \POGOProtos\Networking\Responses\UseItemPotionResponse\Result $value
     */
    public function setResult(\POGOProtos\Networking\Responses\UseItemPotionResponse\Result $value = null)
    {
        $this->result = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.POGOProtos.Networking.Responses.UseItemPotionResponse.Result'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'stamina',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->result = \POGOProtos\Networking\Responses\UseItemPotionResponse\Result::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Responses\UseItemPotionResponse) {
