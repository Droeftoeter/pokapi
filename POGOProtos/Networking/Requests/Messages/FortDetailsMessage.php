...
/**
 * Protobuf message : POGOProtos.Networking.Requests.Messages.FortDetailsMessage
 */
class FortDetailsMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\FortDetailsMessage) {
