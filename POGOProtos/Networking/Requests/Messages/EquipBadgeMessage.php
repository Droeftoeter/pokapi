...
/**
 * Protobuf message : POGOProtos.Networking.Requests.Messages.EquipBadgeMessage
 */
class EquipBadgeMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\EquipBadgeMessage) {
