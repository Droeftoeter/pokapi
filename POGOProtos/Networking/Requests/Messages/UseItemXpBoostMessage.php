...
/**
 * Protobuf message : POGOProtos.Networking.Requests.Messages.UseItemXpBoostMessage
 */
class UseItemXpBoostMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\UseItemXpBoostMessage) {
