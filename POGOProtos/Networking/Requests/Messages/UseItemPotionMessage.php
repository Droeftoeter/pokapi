...
/**
 * Protobuf message : POGOProtos.Networking.Requests.Messages.UseItemPotionMessage
 */
class UseItemPotionMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\UseItemPotionMessage) {
