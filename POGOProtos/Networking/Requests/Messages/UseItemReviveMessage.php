...
/**
 * Protobuf message : POGOProtos.Networking.Requests.Messages.UseItemReviveMessage
 */
class UseItemReviveMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\UseItemReviveMessage) {
