...
/**
 * Protobuf message :
 * POGOProtos.Networking.Requests.Messages.AddFortModifierMessage
 */
class AddFortModifierMessage extends \Protobuf\AbstractMessage
{
    ...
    /**
     * modifier_type optional enum = 1
     *
     * @var \POGOProtos\Inventory\Item\ItemId
     */
    protected $modifier_type = null;
    ...
    /**
     * Check if 'modifier_type' has a value
     *
     * @return bool
     */
    public function hasModifierType()
    {
        return $this->modifier_type !== null;
    }

    /**
     * Get 'modifier_type' value
     *
     ...
     */
    public function setModifierType(\POGOProtos\Inventory\Item\ItemId $value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setModifierType($values['modifier_type']);
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->modifier_type = \POGOProtos\Inventory\Item\ItemId::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\AddFortModifierMessage) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->modifier_type = ($message->modifier_type !== null) ? $message->modifier_type : $this->modifier_type;
