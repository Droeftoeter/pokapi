...
/**
 * Protobuf message :
 * POGOProtos.Networking.Requests.Messages.CheckCodenameAvailableMessage
 */
class CheckCodenameAvailableMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\CheckCodenameAvailableMessage) {
