...
/**
 * Protobuf message : POGOProtos.Networking.Requests.Messages.PlayerUpdateMessage
 */
class PlayerUpdateMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\PlayerUpdateMessage) {
