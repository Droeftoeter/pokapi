 ...
 */
class UseItemEggIncubatorMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\UseItemEggIncubatorMessage) {
