...
/**
 * Protobuf message : POGOProtos.Networking.Requests.Messages.ReleasePokemonMessage
 */
class ReleasePokemonMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\ReleasePokemonMessage) {
