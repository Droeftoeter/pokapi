...
/**
 * Protobuf message : POGOProtos.Settings.DownloadSettingsAction
 */
class DownloadSettingsAction extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Settings\DownloadSettingsAction) {
