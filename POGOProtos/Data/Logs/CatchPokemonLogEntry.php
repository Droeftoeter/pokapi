 ...
 *
 * File descriptor : POGOProtos.Data.Logs.proto
 */
...
/**
 * Protobuf message : POGOProtos.Data.Logs.CatchPokemonLogEntry
 */
class CatchPokemonLogEntry extends \Protobuf\AbstractMessage
{
    ...
    /**
     * combat_points optional int32 = 3
     *
     * @var int
     */
     ...
     * Set 'result' value
     *
     * @param \POGOProtos\Data\Logs\CatchPokemonLogEntry\Result $value
     */
    public function setResult(\POGOProtos\Data\Logs\CatchPokemonLogEntry\Result $value = null)
    {
        $this->result = $value;
    }
    ...
    /**
     * Check if 'combat_points' has a value
     *
     * @return bool
     */
    public function hasCombatPoints()
    {
        return $this->combat_points !== null;
    }

    /**
     * Get 'combat_points' value
     *
     * @return int
     */
    ...
    /**
     * Set 'combat_points' value
     *
     * @param int $value
     */
    public function setCombatPoints($value = null)
    {
        $this->combat_points = $value;
    }

    /**
     * Check if 'pokemon_data_id' has a value
     *
     * @return bool
     */
    public function hasPokemonDataId()
    {
        return $this->pokemon_data_id !== null;
    }

    /**
     * Get 'pokemon_data_id' value
     *
     * @return int
     */
    ...
    /**
     * Set 'pokemon_data_id' value
     *
     * @param int $value
     */
    public function setPokemonDataId($value = null)
    {
        $this->pokemon_data_id = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.POGOProtos.Data.Logs.CatchPokemonLogEntry.Result'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'pokemon_id',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->result = \POGOProtos\Data\Logs\CatchPokemonLogEntry\Result::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 3) {
                ...
                $this->combat_points = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->combat_points !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->combat_points);
        }
    ...
    {
        if ( ! $message instanceof \POGOProtos\Data\Logs\CatchPokemonLogEntry) {
